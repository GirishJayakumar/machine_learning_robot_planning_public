...
class ConfigsGenerator:
    def __init__(self, config_data=None, batch_experiments_sizes=None, parameter_ranges=None):
...
class MPPIConfigsGenerator(ConfigsGenerator):
    ...
    def generate_batch_experiment_configs(self, template_config=None):
        ...
        for set in parameters_sets:
            ...
            experiment_name = 'exp_obs1x{}_obs1y{}_obs1r{}_obs2x{}_obs2y{}_obs2r{}_gamma{}_alpha{}_Numtraj{}'.format(
