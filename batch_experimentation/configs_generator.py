...
class ConfigsGenerator:
    ...
    def create_run_batch_config_file(self, parameters_sets, experiment_names, run_batch_section_name):
        ...
        for experiment_name in experiment_names:
            if run_batch_config[run_batch_section_name]['experiment_names'] != '[':
                run_batch_config[run_batch_section_name]['experiment_names'] += ', '
            run_batch_config[run_batch_section_name]['experiment_names'] += '\'' + experiment_name + '\''
        run_batch_config[run_batch_section_name]['experiment_names'] += ']'
...
class MPPIConfigsGenerator(ConfigsGenerator):
    ...
    def generate_batch_experiment_configs(self, template_config=None):
        ...
        self.create_run_batch_config_file(parameters_sets, experiment_names, 'run_batch_MPPI')
...
class AutorallyCSSMPCConfigsGenerator(ConfigsGenerator):
    ...
    def generate_batch_experiment_configs(self, template_config=None):
        ...
        self.create_run_batch_config_file(parameters_sets, experiment_names, 'run_batch_Autorally_CSSMPC')
...
class AutorallyMPPIConfigsGenerator(ConfigsGenerator):
    ...
    def generate_batch_experiment_configs(self, template_config=None):
        ...
        self.create_run_batch_config_file(parameters_sets, experiment_names, 'run_batch_Autorally_MPPI')